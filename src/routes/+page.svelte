...
<div class="space-y-8">
	...
	{#if currentStep === 0}
		<div transition:fade={{ duration: 500 }} class="space-y-4">
		...
		<div class="space-y-6">
			...
			<div class="flex justify-between">
				<button 
					...
					class="px-4 py-2 border border-slate-300 text-slate-700 rounded-md hover:bg-slate-100 transition-colors duration-200"
				>
					Back
				</button>
				<button 
					on:click={goToNextStep} 
					disabled={!isTrue.trim()} 
					class="px-6 py-2 bg-slate-700 text-white rounded-md hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
				>
					Next
				</button>
	...
	{:else if currentStep === 5}
		<div class="space-y-6">
			...
			<div class="flex justify-between">
				...
				<button 
					on:click={goToNextStep} 
					disabled={!turnaround1.trim() || !turnaround2.trim() || !turnaround3.trim()} 
					class="px-6 py-2 bg-slate-700 text-white rounded-md hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
				>
					Review
				</button>
